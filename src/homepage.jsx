...
export default class Homepage extends Component {
  ...
  fetchProducts = async () => {
    ...
    this.setState({ products, bestSellers, loading: false });
  };
        ...
        <section className="py-12 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-black mb-2 leading-[2] font-sfpro">
                BEST SELLER
              </h3>
              ...
              <div className="flex flex-wrap gap-6 justify-center py-2">
                {bestSellers.slice(0, 4).map((product) => (
                  <button
                    ...
                    className={`w-64 bg-white border border-gray-200 rounded-lg p-4 text-left hover:shadow-lg transition-shadow relative ${
                      product.stock <= 0 ? "opacity-60" : ""
                    }`}
                  >
                    <div className="w-full h-64 bg-gray-100 rounded-lg flex items-center justify-center mb-4 relative">
                      {product.image_url ? (
                        <img
                      ...
                      {product.stock <= 0 && (
                        <span className="absolute inset-0 bg-gray-300/50 flex items-center justify-center text-white font-bold text-lg">
                          Out of Stock
                        </span>
                      )}
                    </div>
